...
fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vQxmzrw_8wtMVlWn-8kRlygSU77Mp7pTf1IWOxX6ABIh7-cp5d5eTPOjxyNpevll9jHzjyieod8AcAC/pub?output=csv")
  ...
  .then(data => {
    ...
    parsed.data.forEach(row => {
      ...
      const links = [];
      if (row.link1) links.push(`<a href="${row.link1}" target="_blank" style="text-decoration: underline; margin-right: 10px; display: inline-block;">외부링크1</a>`);
      if (row.link2) links.push(`<a href="${row.link2}" target="_blank" style="text-decoration: underline; margin-right: 10px; display: inline-block;">외부링크2</a>`);
      if (row.link3) links.push(`<a href="${row.link3}" target="_blank" style="text-decoration: underline; margin-right: 10px; display: inline-block;">외부링크3</a>`);
